...
# ## 概要
#
# N 個の駅にスコア P[i] が与えられる (正/負あり)。M 個の有向制約
#         「a を選んだら b も選ぶ」がある。選び方の利益を最大化する。
#
# ## アルゴリズム
#
# プロジェクト選択問題 → 最小カット (= 最大フロー) に帰着。
...
# ## 計算量
#
# Ford-Fulkerson は最悪 O(VE · 最大フロー) だが、本問は小さいので OK。
#
# ## 読み方の地図
#
# - 問題の型: グラフ / 最大フロー / プロジェクト選択 / 難易度目安: ★5
# - 要約: プロジェクト選択問題を最小カット (= 最大フロー) に帰着して解く。
